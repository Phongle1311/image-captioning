...
\multicolumn{1}{|c|}{} & \textbf{CNN-LSTM} & 0.623 & 0.444 & 0.305 & 0.204 & \multicolumn{1}{c|}{0.197} \\
\multicolumn{1}{|c|}{} & \textbf{CNN-LSTM-Attention} & 0.647 & \textbf{0.469} & \textbf{0.333} & \textbf{0.232} & \multicolumn{1}{c|}{\textbf{0.209}} \\ \hline
...
\multicolumn{1}{|c|}{} & \textbf{CNN-LSTM} & 0.649 & 0.465 & 0.326 & 0.231 & \multicolumn{1}{c|}{0.190} \\ 
\multicolumn{1}{|c|}{} & \textbf{CNN-LSTM-Attention} & \textbf{0.665} & \textbf{0.481} & \textbf{0.344} & \textbf{0.244} & \multicolumn{1}{c|}{\textbf{0.195}} \\ \hline
\end{tabular}%
}
\end{table*}
